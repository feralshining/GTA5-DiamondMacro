...
namespace GTA_DIAMOND_MACRO
{
    public class Keyboard
    {
        ...
        public static void Mouse_Wheel(int amount) {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 0; // 1 = Keyboard Input
            Input.U.mi.dwFlags = MOUSEEVENTF.WHEEL;
            Input.U.mi.mouseData = (uint)amount;
            Inputs[0] = Input;
            SendInput(1, Inputs, INPUT.Size);
        }

        public static void Mouse_Left_Dowm()
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 0; // 1 = Keyboard Input
        ...
        public static void Mouse_Left_Up()
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 0; // 1 = Keyboard Input
        ...
        public static void Mouse_Right_Dowm()
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 0; // 1 = Keyboard Input
        ...
        public static void Mouse_Right_Up()
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 0; // 1 = Keyboard Input
        ...
        public static void FuckingPressKey(ScanCodeShort a) {
            KeyDown(a, false);
            Thread.Sleep(30);
            KeyUP(a, false);
        }

        public static void FuckingPressKey(ScanCodeShort a, bool EXTENDEDKEY)
        {
            KeyDown(a, EXTENDEDKEY);
            Thread.Sleep(30);
            KeyUP(a, EXTENDEDKEY);
        }        
        
        public static void FuckingSendChat(ScanCodeShort a)
        {
            KeyDown(a,false);
            KeyUP(a, false);
        }

        public static void KeyDown(ScanCodeShort a, bool EXTENDEDKEY)
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 1; // 1 = Keyboard Input
            Input.U.ki.wScan = a;
            Input.U.ki.dwFlags = KEYEVENTF.SCANCODE | (EXTENDEDKEY? KEYEVENTF.EXTENDEDKEY: 0);
            Inputs[0] = Input;
            SendInput(1, Inputs, INPUT.Size);
        }
